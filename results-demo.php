...
<body>
 ...
 <div class="one columns"><center><a href="logout.php"><button>Log Out</button></a> <a href="list.php"><button>List of Clients</button></a> <a href="edit.php"><button>Edit Profiles</button></a></center></div>
